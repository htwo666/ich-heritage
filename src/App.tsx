      ...
      <header className="sticky top-0 z-50 bg-white/90 backdrop-blur-md border-b border-gray-100 shadow-sm">
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-8">
            <button
              className={`text-sm font-medium ${currentView === 'list' ? 'text-[#C04851]' : 'text-gray-500'}`}
          ...
          <Button variant="primary" className="md:hidden h-10 w-10 p-0 rounded-full" onClick={handleAddNew}>
            +
          </Button>
        </div>
      </header>
            ...
            <div className="mb-12 flex flex-col md:flex-row md:items-end justify-between gap-6">
              <div>
                ...
                <p className="text-gray-500">
                  目前系统已录入 <span className="text-[#C04851] font-bold">{inheritors.length}</span> 位非遗守护者的档案及作品。
                </p>
              </div>
      ...
      <footer className="bg-gray-900 py-16 text-white border-t-8 border-[#C04851]">
        <div className="max-w-7xl mx-auto px-6 text-center">
          ...
          <p className="text-gray-500 text-sm max-w-xl mx-auto mb-10">
            守一方传统，护一生匠心。您可以点击任何卡片进入详情页对资料进行实时修正或增补。
          </p>
